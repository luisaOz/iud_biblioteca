...
<body>
    <div class="container-fluid">
      <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <div class="row mt-3">
          <div class="col">
            <table class="table table-striped">
              ...
              <tbody>
                <?php
                  if (!empty($usuarios)) { // diferente de vacio
                ...
                <tr>
                  ...
                  <a href="usuario-editar.php?id=<?=$usuario["id_usuario"]?>&nombreUsuario=<?=$usuario["nombre"]?>
                  &telefono=<?=$usuario["telefono"]?>&direccion=<?=$usuario["direccion"]?>" 
                      class="btn btn-dark btn-sm">Editar</a>
                  <a href="usuario-eliminar.php?id=<?=$usuario["id_usuario"]?>&nombreUsuario=<?=$usuario["nombre"]?>
                  &telefono=<?=$usuario["telefono"]?>&direccion=<?=$usuario["direccion"]?>" 
        ...
        <div class="row mb-3">
          <div class="col">
            <a href="usuario-crear.php" class="btn btn-primary">Nuevo registro</a>
          </div>
        </div>
    </div>
</body>
