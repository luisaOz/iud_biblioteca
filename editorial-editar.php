<?php
  ...
  if (isset($_POST["btnEditar"])) {
     $sql = "update editorial set nombre = '" 
    . $_POST["nombre_editorial"] . "' where editorial_id = " . $_POST["editorial_id"] . "" ;
...
<body>
    <div class="container-fluid">
      <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <hr />
        <form action="editorial-editar.php" method="POST">
            <div class="row mb-3">
            <div class="col">
              ...
              <div class="col">
                ...
                <input value="<?= $nombreEditorial?>" type="text" 
                  class="form-control" name="nombre_editorial" required>
              </div>
            </div>
            <div class="row">
                <div class="col">
