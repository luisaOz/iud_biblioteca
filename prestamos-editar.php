...
if (isset($_POST["btnEditar"])) {
  $sql = "   update prestamos set fecha_inicio ='"  . $_POST["fechaInicio"] . "',
  fecha_devolucion  ='" . $_POST["fechadev"] . "'
 where id_prestamo = " . $_POST["idprestamo"] . "" ;
...
<body>
    <div class="container-fluid">
      <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <hr />
        <form action="prestamos-editar.php" method="POST">
            <div class="row mt-3">
